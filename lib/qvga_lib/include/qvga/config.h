...
// ****************************************************************************
// port pins
//	GP8  ... Audio: PWM mono, 22050 Hz, 8 bits unsigned
//	GP11 ... VGA B0 blue
//	GP12 ... VGA B1
//	GP13 ... VGA G0 green
//	GP14 ... VGA G1
...
//	GP17 ... VGA R1
//	GP18 ... VGA R2
//	GP19 ... VGA HSYNC/CSYNC synchronization (inverted: negative SYNC=LOW=0x80, BLACK=HIGH=0x00)
//	GP20 ... VSYNC

// QVGA port pins
#define QVGA_GPIO_FIRST	11	// first QVGA GPIO
...
#define QVGA_GPIO_HSYNC	19	// QVGA HSYNC/CSYNC GPIO
...
// QVGA DMA channel
#define QVGA_DMA_CB	8	// DMA control block of base layer
#define QVGA_DMA_PIO	9	// DMA copy data to PIO (raises IRQ0 on quiet)
