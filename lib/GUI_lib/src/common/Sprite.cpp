...
rpgui::common::Sprite::Sprite(const std::string &name, const std::string &path)
{
...
#ifdef PICOVGA
sCanvas rpgui::common::Sprite::GetCanvas(const sCanvas &toMatch)
{
    auto canvas = sCanvas();
...
const uint8_t *rpgui::common::Sprite::GetImage() const
{
    return _image;
}
...
void rpgui::common::Sprite::loadData(FIL *file)
{
