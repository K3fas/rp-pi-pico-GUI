...
const sLayerProg LayerProg[LAYERPROG_NUM] = {
	...
	// LAYERPROG_BASE base layer
	{
		...
		.extra = {
			// extra offsets, pairs: offset, CPP-correction
			vga_offset_extra1,
			2,
			vga_offset_extra2,
			2,
	...
	// LAYERPROG_BLACK layer with black key color
	{
		...
		.extra = {
			// extra offsets, pairs: offset, CPP-correction
			blacklayer_offset_extra1,
			4,
			blacklayer_offset_extra2,
			3,
		},
	},
	...
	// LAYERPROG_MONO layer with mono pattern or simple color
	{
		...
		.extra = {
			// extra offsets, pairs: offset, CPP-correction
			monolayer_offset_extra1,
			4,
			monolayer_offset_extra2,
			2,
		},
	},
	...
	// LAYERPROG_RLE layer with RLE compression
	{
		...
		.extra = {
			// extra offsets, pairs: offset, CPP-correction
			rlelayer_offset_extra1,
			1,
			rlelayer_offset_extra2,
			3,
			rlelayer_offset_extra3,
			2,
			rlelayer_offset_extra4,
			2,
			rlelayer_offset_extra5,
			3,
			rlelayer_offset_extra6,
			2,
			rlelayer_offset_extra7,
			3,
		},
	},
