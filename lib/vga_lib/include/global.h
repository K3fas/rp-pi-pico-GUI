...
// PicoVGA includes
#include "vga/define.h"     // common definitions of C and ASM
...
#include "vga/vga_pal.h"    // VGA colors and palettes
#include "vga/vga_vmode.h"  // VGA videomodes
#include "vga/vga_layer.h"  // VGA layers
#include "vga/vga_screen.h" // VGA screen layout
#include "vga/vga_util.h"   // VGA utilities
#include "vga/vga.h"        // VGA output
#include "vga/vga.pio.h"
