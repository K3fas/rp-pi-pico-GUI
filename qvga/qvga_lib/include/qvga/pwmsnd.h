...
// current sound
extern const uint8_t *CurSound;	// current playing sound
...
extern const uint8_t *NextSound;	// next sound to play repeated sound
...
void PlaySound(const uint8_t *snd, int len, bool rep = false, float speed = 1.0f);
