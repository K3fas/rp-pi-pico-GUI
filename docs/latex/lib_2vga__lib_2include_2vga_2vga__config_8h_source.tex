\hypertarget{lib_2vga__lib_2include_2vga_2vga__config_8h_source}{}\doxysection{vga\+\_\+config.\+h}
\label{lib_2vga__lib_2include_2vga_2vga__config_8h_source}\index{lib/vga\_lib/include/vga/vga\_config.h@{lib/vga\_lib/include/vga/vga\_config.h}}
...
\DoxyCodeLine{61 \textcolor{comment}{//  GP0 ... VGA B0 blue}}
\DoxyCodeLine{62 \textcolor{comment}{//  GP1 ... VGA B1}}
\DoxyCodeLine{63 \textcolor{comment}{//  GP2 ... VGA G0 green}}
\DoxyCodeLine{64 \textcolor{comment}{//  GP3 ... VGA G1}}
\DoxyCodeLine{65 \textcolor{comment}{//  GP4 ... VGA G2}}
\DoxyCodeLine{66 \textcolor{comment}{//  GP5 ... VGA R0 red}}
\DoxyCodeLine{67 \textcolor{comment}{//  GP6 ... VGA R1}}
\DoxyCodeLine{68 \textcolor{comment}{//  GP7 ... VGA R2}}
\DoxyCodeLine{69 \textcolor{comment}{//  GP8 ... VGA SYNC synchronization (inverted: negative SYNC=LOW=0x80, BLACK=HIGH=0x00)}}
\DoxyCodeLine{70 \textcolor{preprocessor}{\#define VGA\_GPIO\_FIRST 11                                 }\textcolor{comment}{// first VGA GPIO}}
\DoxyCodeLine{71 \textcolor{preprocessor}{\#define VGA\_GPIO\_NUM 10                                    }\textcolor{comment}{// number of VGA GPIOs, including HSYNC and VSYNC}}
