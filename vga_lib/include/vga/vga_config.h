...
#define SEGMAX 1   // max. number of video segment per video strip (size of 1 sSegm = 28 bytes)
#define STRIPMAX 1 // max. number of video strips (size of 1 sStrip = sSegm size*SEGMAX+4 = 228 bytes)
